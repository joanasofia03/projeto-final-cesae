...
CREATE TABLE AppRole (
    ID INT IDENTITY PRIMARY KEY CONSTRAINT PK_AppRole_ID,
    RoleName VARCHAR(50) UNIQUE NOT NULL
);

-- Tabela: AppUser
CREATE TABLE AppUser (
    ID INT IDENTITY PRIMARY KEY CONSTRAINT PK_AppUser_ID,
...
CREATE TABLE Dim_Time (
    ID INT IDENTITY PRIMARY KEY CONSTRAINT PK_Dim_Time_ID,
...
CREATE TABLE Dim_Account (
    ID INT IDENTITY PRIMARY KEY CONSTRAINT PK_Dim_Account_ID,
    Account_Type VARCHAR(30) NULL,
    Account_Status VARCHAR(20) NULL,
    User_ID INT NULL,
    Opening_Date DATE NULL,
    Currency VARCHAR(10) NULL,
    CONSTRAINT FK_Dim_Account_User FOREIGN KEY (User_ID) REFERENCES AppUser(ID)
);

-- Dimensão: Transaction Type
CREATE TABLE Dim_Transaction_Type (
    ID INT IDENTITY PRIMARY KEY CONSTRAINT PK_Dim_Transaction_Type_ID,
    Dim_Transaction_Type_Description VARCHAR(50) NULL
);

-- Dimensão: Market Asset
CREATE TABLE Dim_Market_Asset (
    ID INT IDENTITY PRIMARY KEY CONSTRAINT PK_Dim_Market_Asset_ID,
...
CREATE TABLE Fact_Transactions (
    ID INT IDENTITY PRIMARY KEY CONSTRAINT PK_Fact_Transactions_ID,
...
CREATE TABLE Fact_Market_Asset_History (
    ID INT IDENTITY PRIMARY KEY CONSTRAINT PK_Fact_Market_Asset_History_ID,
    Asset_ID INT NULL,
    Time_ID INT NULL,
...
CREATE TABLE Fact_Notifications (
    ID INT IDENTITY PRIMARY KEY CONSTRAINT PK_Fact_Notifications_ID,
    AppUser_ID INT NULL,
    Time_ID INT NULL,
